...
### Purpose filter is a tab bar, with digit shortcuts

The purpose filter (General, DevOps, Spec-Driven Ops, Quality, Security,
Integrations, Tooling, Frontend, Other, plus "Todos") renders as one row of
full-width tabs instead of a wrapping line of pills — same per-purpose
